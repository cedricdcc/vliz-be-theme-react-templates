...
export default function Navigation() {
    ...
    return (
                ...
                <a href="/" rel="home" title="">
                    ...
                    <g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1"
                        ...
                        <text xml:space="preserve"
                            style="font-style:normal;font-weight:normal;font-size:29.6246px;line-height:1.25;font-family:sans-serif;fill:#000000;fill-opacity:1;stroke:none;stroke-width:1"
                            x="0.085727908" y="149.49635" id="text4541">
                            <tspan sodipodi:role="line" id="tspan4539" x="15.085727908" y="149.49635"
                            style="fill:#65c9cd;fill-opacity:1;stroke-width:1">open science</tspan>
                        </text>
                        </g>
                    </g>
                    </svg>
            ...
            <div class="header-content">
                ...
                <div class="region region-header-navigation">
                    ...
                    <ul class="menu">
                        ...
                        <a {% if item.highlight %}class="highlight" {% endif %} href="{{ site.base_url }}{{ item.url }}"
                            data-doormat-target="doormat-block-hoofdnavigatie{% if forloop.index != 1 %}-{{ forloop.index }}{% endif %}">{{
                            item.title }}</a>
                        </li>
                        {% else %}
                        <li class="menu-item">
                        <a {% if item.highlight %}class="highlight" {% endif %} href="{{ site.base_url }}{{ item.url }}">{{ item.title }}</a>
                        </li>
                        {% endif %}
                        {% endfor %}
                    </ul>
        ...
        <div class="region region-header-doormat">
            {% if site.data.navigation %}
            {% for item in site.data.navigation %}
            <div id="block-hoofdnavigatie{% if forloop.index != 1 %}-{{ forloop.index }}{% endif %}"
            class="block block-menu-block block-menu-blockmain block-doormat"
            data-doormat-id="doormat-block-hoofdnavigatie{% if forloop.index != 1 %}-{{ forloop.index }}{% endif %}">
            <div class="doormat-inner">
                ...
                <li class="menu-item menu-item--expanded">
                    <a 
                    href="{{ site.base_url }}{{subitem.url}}"
                    {% unless subitem.url contains site.base_url %}
                    target="blank"
                    {% endunless %}
                    >{{subitem.title}}
                    </a>
                    ...
                    <li class="menu-item">
                        <a 
                        href="{{ site.base_url }}{{subsubitem.url}}"
                        {% unless subsubitem.url contains site.base_url %}
                        target="blank"
                        {% endunless %}
                        >{{subsubitem.title}}</a>
                    </li>
